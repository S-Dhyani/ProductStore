import { Box,useDisclosure ,VStack,Input,Button,Text,Heading,HStack,IconButton,Image, useColorModeValue, useToast, Modal, ModalOverlay,ModalHeader, ModalContent, ModalCloseButton, ModalBody, ModalFooter } from '@chakra-ui/react'
        ...
        <Box p={4}>
            <Heading as='h3' size='md' mb={2}>
                ...
                <HStack spacing={2}>
                    ...
                    <IconButton onClick={()=>handleClick(product._id)} icon={<DeleteIcon/>} colorScheme='red'/>
                </HStack>
        </Box>
